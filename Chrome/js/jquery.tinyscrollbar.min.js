(function (a) {
	function b(b, c) {
		...
		var e = b;
		var f = {
			obj : a(".exif-viewport", b)
		};
		var g = {
			obj : a(".exif-overview", b)
		};
		var h = {
			obj : a(".exif-scrollbar", b)
		};
		var i = {
			obj : a(".exif-track", h.obj)
		};
		var j = {
			obj : a(".exif-thumb", h.obj)
		};
		var k = c.axis == "x",
		l = k ? "left" : "top",
		m = k ? "Width" : "Height";
	...
	a.fn.tinyscrollbar = function (c) {
		if(c && c == "update"){
			var z =a(this).data("tsb");
			return z?z.update(b):z;
		} else {
