...
java -jar compiler.jar --compilation_level ADVANCED_OPTIMIZATIONS --externs=externs\jquery.js --externs=externs\chrome.js  --js=..\Chrome\re.js  --js=..\Chrome\page.js  --js=..\Chrome\exif_inject.js --js_output_file=.\Output\exif_inject.js
